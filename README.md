## rosbag_image_compressor (hydro) - 0.1.4-0

The packages in the `rosbag_image_compressor` repository were released into the `hydro` distro by running `/usr/bin/bloom-release -t hydro -r hydro rosbag_image_compressor` on `Tue, 16 Dec 2014 07:55:54 -0000`
...
## rosbag_image_compressor (hydro) - 0.1.3-0

The packages in the `rosbag_image_compressor` repository were released into the `hydro` distro by running `/usr/bin/bloom-release -r hydro -t hydro rosbag_image_compressor` on `Fri, 05 Sep 2014 00:55:12 -0000`
...
## rosbag_image_compressor (indigo) - 0.1.2-0
